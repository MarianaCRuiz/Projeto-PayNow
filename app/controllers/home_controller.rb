  ...
  def check_current_user
    if current_user
      ...
      if domain == "paynow.com.br" && !Admin.where(email: current_user.email).empty?        
        ...
        DomainRecord.create(email: current_user.email, domain: domain, company: current_user.company)  #        puts 'NEW C'
      end
    end
  end
