...
describe BoletoRegisterOption do
  ...
  let(:boleto) {BoletoRegisterOption.new(company: company, payment_option: pay_1, bank_code: bank,
                                         agency_number: '2050', account_number: '123.555-8')}
  let(:user_admin) {User.create!(email: 'admin@codeplay.com', password: '123456', role: 1, boleto: boleto)}
  let(:user) {User.create!(email: 'user@codeplay.com', password: '123456', role: 0, boleto: boleto)}    
  ...
  it 'do not need to be uniq scope just agency, different bank' do
    BoletoRegisterOption.create!(company: company, payment_option: pay_1, bank_code: bank, agency_number: '2050', account_number: '123.555-8')
    boleto_2 = BoletoRegisterOption.new(company: company, payment_option: pay_1, bank_code: bank2, agency_number: '2050', account_number: '123.555-8')
    boleto_2.valid?
