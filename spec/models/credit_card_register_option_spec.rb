...
describe CreditCardRegisterOption do
  ...
  let(:credit_card) { CreditCardRegisterOption.new(company: company, payment_option: pay_creditcard_1,
  ...
  it 'credit_card_operator_token must be uniq scope company' do
    CreditCardRegisterOption.create!(company: company, payment_option: pay_creditcard_1,
                                     credit_card_operator_token: 'jdB8SD923Nmg8fR1GhJm')
    credit_card_2 = CreditCardRegisterOption.new(company: company, payment_option: pay_creditcard_1,
                                                 credit_card_operator_token: 'jdB8SD923Nmg8fR1GhJm')
    credit_card_2.valid?
