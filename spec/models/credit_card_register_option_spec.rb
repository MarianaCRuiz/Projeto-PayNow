...
describe CreditCardRegisterOption do
  ...
  let(:credit_card) {CreditCardRegisterOption.new(company: company, payment_option: pay_creditcard_1, bank_code: bank,
                                         agency_number: '2050', account_number: '123.555-8')}
  let(:pay_creditcard_1) {PaymentOption.create!(name: 'CreditCard', fee: 1.9, max_money_fee: 20, payment_type: 1)}
  ...
  it 'credit_card_operator_token must be uniq scope company' do
    CreditCardRegisterOption.create!(company: company, payment_option: pay_creditcard_1, credit_card_operator_token: 'jdB8SD923Nmg8fR1GhJm')
    credit_card_2 = CreditCardRegisterOption.new(company: company, payment_option: pay_creditcard_1, credit_card_operator_token: 'jdB8SD923Nmg8fR1GhJm')
    credit_card_2.valid?
