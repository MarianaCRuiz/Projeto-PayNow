...
describe PixRegisterOption do
  ...
  let(:pix) do
    PixRegisterOption.new(company: company, payment_option: pay_creditcard1,
                          pix_key: 'AJ86gt4fLBtcF296rTuN', bank_code: bank)
  end
  let(:pay_creditcard1) { PaymentOption.create!(name: 'Pix', fee: 1.9, max_money_fee: 20, payment_type: 1) }
