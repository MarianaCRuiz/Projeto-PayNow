...
describe 'consult charges api' do
  ...
  context 'filter due deadline' do
    ...
    it 'filter due deadline max' do
      ...
      get '/api/v1/consult_charges',
          params: { consult: { due_deadline_max: '20/09/2021' }, company_token: company.token }
    ...
    it 'filter due deadline min' do
      ...
      get '/api/v1/consult_charges',
          params: { consult: { due_deadline_min: '20/09/2021' }, company_token: company.token }
      ...
      expect(parsed_body[0]['payment_method']).to eq('Boleto')
      expect(parsed_body[1]['product_name']).to eq('Produto 2')
      expect(parsed_body[1]['price']).to eq('60.0')
      expect(parsed_body[1]['discount']).to eq('3.0')
      expect(parsed_body[1]['charge_price']).to eq('57.0')
      expect(parsed_body[1]['client_name']).to eq('Cliente final 2')
      expect(parsed_body[1]['client_cpf']).to eq('11133355599')
      expect(parsed_body[1]['payment_method']).to eq('Cartão de Crédito MasterChef')
    end
    it 'filter due deadline min and max' do
      ...
      get '/api/v1/consult_charges',
          params: { consult: { due_deadline_min: '20/09/2021', due_deadline_max: '20/09/2023' },
  ...
  context 'failure' do
    ...
    it 'filter due deadline max' do
      ...
      get '/api/v1/consult_charges',
          params: { consult: { due_deadline_max: '20/09/2020' }, company_token: company.token }
    ...
    it 'filter due deadline min' do
      ...
      get '/api/v1/consult_charges',
          params: { consult: { due_deadline_min: '20/09/2030' }, company_token: company.token }
    ...
    it 'filter due deadline min and max' do
      ...
      get '/api/v1/consult_charges',
          params: { consult: { due_deadline_min: '20/09/2022', due_deadline_max: '20/09/2021' },
                    company_token: company.token }
