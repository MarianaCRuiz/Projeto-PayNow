...
DomainRecord.create!(email_client_admin: 'user1@empresa1.com', domain: 'empresa1.com')
...
bank2 = BankCode.create!(code: '029', bank:'Banco Itaú Consignado S.A.')

BoletoRegisterOption.create!(company: company_1, name: pay_1.name, bank_code: bank1, agency_number: '2050', account_number: '123.555-8')
CreditCardRegisterOption.create!(company: company_1, name: pay_3.name, credit_card_operator_token: SecureRandom.base58(20))
PixRegisterOption.create!(company: company_1, name: pay_2.name, pix_key: SecureRandom.base58(20), bank_code: bank2)
